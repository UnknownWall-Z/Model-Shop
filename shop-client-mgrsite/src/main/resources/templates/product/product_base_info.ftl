	...
	<div class="row">
		<div class="col-lg-6">
			<div class="form-group">
				<label>商品名称</label> <input class="form-control" name="product.name">
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
				<label>商品编号</label> <input class="form-control" name="product.code">
			</div>
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
		<div class="col-lg-6">
			<div class="form-group">
				<label>是否上架</label>
				<div>
					<label class="radio-inline"> <input type="radio" name="product.shelves" value="true" checked>是 </label>
					<label class="radio-inline"> <input type="radio" name="product.shelves" value="false">否 </label>
				</div>
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
				<label>是否推荐</label>
				<div>
					<label class="radio-inline"> <input type="radio" name="product.recommended" value="true" checked>是</label>
                    <label class="radio-inline"> <input type="radio"name="product.recommended" value="false">否</label>
				</div>
			</div>
		</div>
	</div>
