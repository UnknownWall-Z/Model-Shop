            ...
            <tr>
                ...
                <#list skuPropertieList as skuProperty>
                    <th>
                        ...
                        <input type="hidden" name="productSkuList[${sku_index}].productSkuProperties[${skuProperty_index}].skuProperty.id" value="${skuProperty.id}">
                        <input type="hidden" name="productSkuList[${sku_index}].productSkuProperties[${skuProperty_index}].value" value="${sku[skuProperty.name]}">
                    </th>
                </#list>
                <td>
